...
(function ($) {
    ...
    function getDateTimeString(dateTimeInJsonFormat, enableTimePicker) {
        var selectedDateTimeString =
                        toEnglishNumber(zeroPad(dateTimeInJsonFormat.Year)) + '/' +
                            toEnglishNumber(zeroPad(dateTimeInJsonFormat.Month)) + '/' +
                            toEnglishNumber(zeroPad(dateTimeInJsonFormat.Day));
        if (enableTimePicker)
            selectedDateTimeString = selectedDateTimeString + '  ' + toEnglishNumber(zeroPad(dateTimeInJsonFormat.Hour)) +
                ':' + toEnglishNumber(zeroPad(dateTimeInJsonFormat.Minute)) +
                ':' + toEnglishNumber(zeroPad(dateTimeInJsonFormat.Second));
